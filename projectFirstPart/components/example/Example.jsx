...
class Example extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            motto: window.cs142models.exampleMotto().motto,
            counter: 0,
            inputValue: '',
            buttonWasClicked: '',
        };
        ...
        return (
            <div className="container Example">
                ...
                <div className="motto-update">
                    {
                    <p className = "motto-display">
                        My motto is <code> &ldquo; {this.state.motto} &rdquo;. </code> <br />
                        Update Motto: <input id="inId" type="text" onChange={this.updateMotto}></input>
                    </p>
                    }
                </div>
                <p>
